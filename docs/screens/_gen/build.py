...
MODULES = [
    ...
    ('p_tkt01', 'TKT-01_N Key 발급.html'),
    ('p_tkt03', 'TKT-03_계정 발급.html'),
    ('p_tkt06', 'TKT-06_계정 등록·수정.html'),
    ('p_tkt04', 'TKT-04_Key 발급 정산.html'),
...
SUM = {
    ...
    'TKT-01': ['미선택', '범위 없음', '발급 준비', '범위 목록', '공통코드', '개별티켓', '사용기한', '범위 초과', '검증 7', '생성 성공', 'TKT-02 모달 3'],
    'TKT-03': ['목록 8열', '계정 없음', '필터·검색', '결과 없음', '삭제 확인'],
    'TKT-06': ['등록 3단계', '권한 모두', '권한 개별', '폼솔루션·SDK', 'App Key 선택', '검증 5', '상세·수정', '키 발급', '계정 삭제'],
    'TKT-04': ['목록 10열', '체험 만료·대장', '필터 3종', '정렬', '결과 없음', '이력 없음', 'TKT-02', 'TKT-05 4종', '금액 오류', '삭제'],
    'SOB-01': ['PDS3/PDS2 전환', '상태 필터 5', '고객사 검색', '번호 점프', '결과 없음 2', 'Owner 배지 3', 'Page 용량 2', '더 보기·툴팁'],
