...
MODULES = [
    ...
    ('p_tkt01', 'TKT-01_티켓 발급.html'),
    ('p_tkt03', 'TKT-03_계정+App Key.html'),
    ('p_tkt04', 'TKT-04_발급 목록 및 정산.html'),
...
SUM = {
    ...
    'TKT-03': ['미선택', '신규 계정', '기존 계정', '신규 전환', '범위 목록', '범위 없음', 'SDK 연동', '만료일', '발급 완료', '검증 6', '서비스 DB', '계정 삭제'],
