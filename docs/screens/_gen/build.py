...
SUM = {
    ...
    'DSH-01': ['4구역 · KPI 3', '활동 없음', 'Section 경고', 'STAFF 동일'],
    'MEM-01': ['11열 표+구분필터', '하위 필터', '결과없음', '종료 업체', '삭제 2', '초기화', '완료 알림'],
    'MEM-02': ['등록 기본정보', '상세·메모', '단가 탭', '서류 탭', '업체명 오류', '상위 회사', '전용 단가', '종료 선택', '메모 입력', '남의 메모', '메모 삭제'],
    ...
    'TKT-02': ['등록 2단계', '사용처 중복', '권한 개별', '준비중 탭', 'App Key 선택', 'CasterN 미선택', '검증 6', '상세·수정', '키 발급', '범위 추가', '계정 삭제', '대장 계정'],
    ...
    'PRJ-05': ['고객사 미선택', 'Owner 선택', 'Owner 1개', '할당 코드 없음'],
